...
export interface Exists {
  ...
  homeContent: (where?: HomeContentWhereInput) => Promise<boolean>;
...
export interface Prisma {
  ...
  homeContents: (
    args?: {
      ...
      orderBy?: HomeContentOrderByInput;
      skip?: Int;
      after?: String;
      before?: String;
      first?: Int;
  ...
  ) => Promise<Array<HomeContentNode>>;
  homeContentsConnection: (
    args?: {
      where?: HomeContentWhereInput;
      orderBy?: HomeContentOrderByInput;
      skip?: Int;
  ...
  updateManyFaqs: (
    args: { data: FaqUpdateInput; where?: FaqWhereInput }
  ) => BatchPayload;
  upsertFaq: (
    args: {
  ...
  updateHomeContent: (
    args: { data: HomeContentUpdateInput; where: HomeContentWhereUniqueInput }
  ) => HomeContent;
  updateManyHomeContents: (
    args: { data: HomeContentUpdateInput; where?: HomeContentWhereInput }
  ) => BatchPayload;
  upsertHomeContent: (
    args: {
      where: HomeContentWhereUniqueInput;
      create: HomeContentCreateInput;
      update: HomeContentUpdateInput;
    }
  ) => HomeContent;
...
export interface Subscription {
  ...
  homeContent: (
    where?: HomeContentSubscriptionWhereInput
  ) => HomeContentSubscriptionPayloadSubscription;
  post: (
...
export type HomeContentOrderByInput =
  | "id_ASC"
  | "id_DESC"
  | "heading_ASC"
  | "heading_DESC"
...
export type HomeContentWhereUniqueInput = AtLeastOne<{
  id: ID_Input;
}>;

export interface HomeContentCreateInput {
  heading: String;
  subheading: String;
  heroImageUrl: String;
}

export interface HomeContentWhereInput {
  id?: ID_Input;
  id_not?: ID_Input;
  id_in?: ID_Input[] | ID_Input;
  id_not_in?: ID_Input[] | ID_Input;
  ...
  subheading_in?: String[] | String;
  subheading_not_in?: String[] | String;
  ...
  OR?: HomeContentWhereInput[] | HomeContentWhereInput;
...
export interface HomeContentSubscriptionWhereInput {
  mutation_in?: MutationType[] | MutationType;
  updatedFields_contains?: String;
  updatedFields_contains_every?: String[] | String;
  updatedFields_contains_some?: String[] | String;
  node?: HomeContentWhereInput;
  AND?: HomeContentSubscriptionWhereInput[] | HomeContentSubscriptionWhereInput;
  OR?: HomeContentSubscriptionWhereInput[] | HomeContentSubscriptionWhereInput;
  NOT?: HomeContentSubscriptionWhereInput[] | HomeContentSubscriptionWhereInput;
}
...
export interface HomeContentConnectionNode {}

export interface HomeContentConnection
  extends Promise<HomeContentConnectionNode>,
    Fragmentable {
  pageInfo: <T = PageInfo>() => T;
  edges: <T = Promise<Array<HomeContentEdgeNode>>>() => T;
  aggregate: <T = AggregateHomeContent>() => T;
}

export interface HomeContentConnectionSubscription
  extends Promise<AsyncIterator<HomeContentConnectionNode>>,
    Fragmentable {
  pageInfo: <T = PageInfoSubscription>() => T;
  edges: <
    T = Promise<AsyncIterator<Array<HomeContentEdgeSubscription>>>
  >() => T;
  aggregate: <T = AggregateHomeContentSubscription>() => T;
}

export interface FaqConnectionNode {}

export interface FaqConnection
  extends Promise<FaqConnectionNode>,
    Fragmentable {
  pageInfo: <T = PageInfo>() => T;
  edges: <T = Promise<Array<FaqEdgeNode>>>() => T;
  aggregate: <T = AggregateFaq>() => T;
}

export interface FaqConnectionSubscription
  extends Promise<AsyncIterator<FaqConnectionNode>>,
    Fragmentable {
  pageInfo: <T = PageInfoSubscription>() => T;
  edges: <T = Promise<AsyncIterator<Array<FaqEdgeSubscription>>>>() => T;
  aggregate: <T = AggregateFaqSubscription>() => T;
}

export interface HomeContentEdgeNode {
  cursor: String;
}

export interface HomeContentEdge
  extends Promise<HomeContentEdgeNode>,
    Fragmentable {
  node: <T = HomeContent>() => T;
  cursor: () => Promise<String>;
}

export interface HomeContentEdgeSubscription
  extends Promise<AsyncIterator<HomeContentEdgeNode>>,
    Fragmentable {
  node: <T = HomeContentSubscription>() => T;
  cursor: () => Promise<AsyncIterator<String>>;
}

export interface FaqEdgeNode {
  cursor: String;
}

export interface FaqEdge extends Promise<FaqEdgeNode>, Fragmentable {
  node: <T = Faq>() => T;
  cursor: () => Promise<String>;
}

export interface FaqEdgeSubscription
  extends Promise<AsyncIterator<FaqEdgeNode>>,
    Fragmentable {
...
export interface HomeContentNode {
  id: ID_Output;
  heading: String;
  subheading: String;
  heroImageUrl: String;
...
export interface HomeContent extends Promise<HomeContentNode>, Fragmentable {
  id: () => Promise<ID_Output>;
  heading: () => Promise<String>;
  subheading: () => Promise<String>;
  heroImageUrl: () => Promise<String>;
}

export interface HomeContentSubscription
  extends Promise<AsyncIterator<HomeContentNode>>,
    Fragmentable {
  id: () => Promise<AsyncIterator<ID_Output>>;
  heading: () => Promise<AsyncIterator<String>>;
  subheading: () => Promise<AsyncIterator<String>>;
...
export interface Faq extends Promise<FaqNode>, Fragmentable {
  id: () => Promise<ID_Output>;
...
export interface FaqSubscription
  extends Promise<AsyncIterator<FaqNode>>,
    Fragmentable {
  id: () => Promise<AsyncIterator<ID_Output>>;
...
export interface FaqSubscriptionPayloadNode {
  mutation: MutationType;
  updatedFields?: String[];
}

export interface FaqSubscriptionPayload
  extends Promise<FaqSubscriptionPayloadNode>,
    Fragmentable {
  mutation: () => Promise<MutationType>;
  node: <T = Faq>() => T;
  updatedFields: () => Promise<String[]>;
  previousValues: <T = FaqPreviousValues>() => T;
}

export interface FaqSubscriptionPayloadSubscription
  extends Promise<AsyncIterator<FaqSubscriptionPayloadNode>>,
    Fragmentable {
  mutation: () => Promise<AsyncIterator<MutationType>>;
  node: <T = FaqSubscription>() => T;
  updatedFields: () => Promise<AsyncIterator<String[]>>;
...
export interface AggregateHomeContentNode {
  count: Int;
}

export interface AggregateHomeContent
  extends Promise<AggregateHomeContentNode>,
    Fragmentable {
  count: () => Promise<Int>;
}

export interface AggregateHomeContentSubscription
  extends Promise<AsyncIterator<AggregateHomeContentNode>>,
    Fragmentable {
  count: () => Promise<AsyncIterator<Int>>;
}

export interface HomeContentPreviousValuesNode {
  id: ID_Output;
  heading: String;
  subheading: String;
  heroImageUrl: String;
...
export interface HomeContentPreviousValues
  extends Promise<HomeContentPreviousValuesNode>,
    Fragmentable {
  id: () => Promise<ID_Output>;
  heading: () => Promise<String>;
  subheading: () => Promise<String>;
...
export interface HomeContentPreviousValuesSubscription
  extends Promise<AsyncIterator<HomeContentPreviousValuesNode>>,
    Fragmentable {
  id: () => Promise<AsyncIterator<ID_Output>>;
  heading: () => Promise<AsyncIterator<String>>;
  subheading: () => Promise<AsyncIterator<String>>;
...
export interface HomeContentSubscriptionPayloadNode {
  mutation: MutationType;
  updatedFields?: String[];
}

export interface HomeContentSubscriptionPayload
  extends Promise<HomeContentSubscriptionPayloadNode>,
    Fragmentable {
  mutation: () => Promise<MutationType>;
  node: <T = HomeContent>() => T;
  updatedFields: () => Promise<String[]>;
  previousValues: <T = HomeContentPreviousValues>() => T;
}

export interface HomeContentSubscriptionPayloadSubscription
  extends Promise<AsyncIterator<HomeContentSubscriptionPayloadNode>>,
    Fragmentable {
  mutation: () => Promise<AsyncIterator<MutationType>>;
  node: <T = HomeContentSubscription>() => T;
  updatedFields: () => Promise<AsyncIterator<String[]>>;
  previousValues: <T = HomeContentPreviousValuesSubscription>() => T;
}

export interface AggregateFaqNode {
  count: Int;
}

export interface AggregateFaq extends Promise<AggregateFaqNode>, Fragmentable {
  count: () => Promise<Int>;
}

export interface AggregateFaqSubscription
  extends Promise<AsyncIterator<AggregateFaqNode>>,
    Fragmentable {
  count: () => Promise<AsyncIterator<Int>>;
}

export interface FaqPreviousValuesNode {
  id: ID_Output;
  title: String;
  body: String;
}
...
export interface FaqPreviousValues
  extends Promise<FaqPreviousValuesNode>,
    Fragmentable {
  id: () => Promise<ID_Output>;
  title: () => Promise<String>;
  body: () => Promise<String>;
...
export interface FaqPreviousValuesSubscription
  extends Promise<AsyncIterator<FaqPreviousValuesNode>>,
    Fragmentable {
  id: () => Promise<AsyncIterator<ID_Output>>;
  title: () => Promise<AsyncIterator<String>>;
  body: () => Promise<AsyncIterator<String>>;
