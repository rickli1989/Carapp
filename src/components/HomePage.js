    ...
    return (
      <div
        ...
        style={{
          backgroundImage:
            'url(' +
            this.props.homeContentQuery.homeContents[0].heroImageUrl +
            ')'
        }}
      >
        <div className={classes.overlay}>
          <h1 className={classes.heading}>
            {this.props.homeContentQuery.homeContents[0].heading}
          </h1>
          <h3 className={classes.subheading}>
            {this.props.homeContentQuery.homeContents[0].subheading} |{' '}
